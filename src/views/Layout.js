    ...
    <div className="Layout-background">
      <div className={classes.toolbar} id="navbar__emailDisplay">
        <form action="/dashboard">
          <button className="btn btn-success">Pet Store</button>
        </form>
      </div>
      <Divider />
        ...
        {data.personal.role === "admin" ? (
          <>
            ...
            <ListItem onClick={handleClickOfAdminUser}>
              ...
              <ListItemText primary="Users" className="text-white" />
              {openAdminUser ? (
            ...
            <Collapse in={openAdminUser} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                ...
                <Link className="text-white" to="/viewUsers">
                  <ListItem sx={{ pl: 4 }}>
                    <ListItemIcon className="text-white">
          ...
          <>
            ...
            >
              <List component="div" disablePadding>
                <Link
                  className="text-dark"
                  to="/reviewLeaveRequests?type=tyres"
                >
                  <ListItem sx={{ pl: 4 }}>
                    <ListItemIcon>
                      <DoneAllIcon />
            ...
            <Toolbar>
              ...
              {data.isLoggedIn ? (
                <span className="profileTabNavbar">
                  ...
                  <Button className="logout-Navbar" onClick={logout}>
                    Logout
                  </Button>
                </span>
              ) : (
